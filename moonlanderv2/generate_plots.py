import numpy as np
from plotting import plot_learning_curves, plot_tsne_weights, plot_umap_weights, plot_average_reward_by_planet_type
...
def generate_plots(data, output_prefix,title):
    ...
    plot_average_reward_by_planet_type(data, f"{output_prefix}_avg_reward_by_type.png", title=title)
