    ...
    try:
        ...
        run_isolated(
            ...
            kwargs={
                ...
                'alpha': 0.3  # Gradual weight update: 70% old + 30% new
            }
        )
    ...
    try:
        run_isolated(
            ...
            kwargs={
                ...
                'DP_EPSILON': 30.0,
                'clients_per_round': clients_per_round,
                'server_lr': 0.1  # Apply 10% of noisy delta each round
            }
        )
        elapsed_time = time.perf_counter() - start_time
    ...
    try:
        run_isolated(
            ...
            kwargs={
                ...
                'DP_EPSILON': 30.0,
                'clients_per_round': clients_per_round,
                'server_lr': 0.15  # Higher LR for tighter clipping
            }
        )
        elapsed_time = time.perf_counter() - start_time
    ...
    try:
        run_isolated(
            ...
            kwargs={
                ...
                'DP_EPSILON': 30.0,
                'clients_per_round': clients_per_round,
                'server_lr': 0.2  # Higher LR for very tight clipping
            }
        )
        elapsed_time = time.perf_counter() - start_time
